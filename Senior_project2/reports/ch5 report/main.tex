...
\lstinputlisting[language=Java, caption=Welcome.java]{attachments/welcome.java}
\newpage
\begin{itemize}
    \item Customer
    \item Barber
...
\lstinputlisting[language=Java, caption=signup login.java]{attachments/signup_login.java}
\newpage
\begin{figure}[ht]
    \centering
...
\lstinputlisting[language=Java, caption=login.java]{attachments/login.java}
...
\lstinputlisting[language=Java, caption=signup.java]{attachments/signup.java}
...
\end{figure}
\lstinputlisting[language=Java, caption="password reset"]{attachments/password_reset.java}
...
\lstinputlisting[language=Java, caption=code verification.java]{attachments/code_verification.java}
