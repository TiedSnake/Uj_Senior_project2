...
\lstinputlisting[language=Java, caption=Welcome.java]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/welcome.java}
\newpage
\begin{itemize}
    \item Customer
    \item Barber
...
\lstinputlisting[language=Java, caption=signup login.java]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/signup_login.java}
\newpage
\begin{figure}[ht]
    \centering
...
\lstinputlisting[language=Java, caption=login.java]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/login.java}
...
\lstinputlisting[language=Java, caption=signup.java]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/signup.java}
...
\end{figure}
\lstinputlisting[language=Java, caption="password reset"]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/password_reset.java}
...
\lstinputlisting[language=Java, caption=code verification.java]{../../Project_Code/Haircut/app/src/main/java/com/example/haircut/code_verification.java}
