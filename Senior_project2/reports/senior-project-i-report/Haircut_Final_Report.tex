...
\hline
\textbf{Text} & \textbf{Names} \textbf{ID(s)} \\
\hline
 ...
 &  \\
\hline
\multicolumn{2}{|l|}{\textbf{Supervisor:}} \\
\multicolumn{2}{|l|}{Something something} \\
\hline
\end{tabular}
...
\item \subsubsection{Chapter 1}
      
\item \paragraph{Introduction}
      
\item * A general introduction of the proposed service.
      
\item \paragraph{General Context}
      
\item  * A description of the general context of the services.
      
      \paragraph{Problem Definition}
      
      * The problem the service offers to solve.
      ...
      * List of measurable objectives which should be satisfied for the service to meet its aims.
      
      \paragraph{Proposed Solution}
      
      * A brief description of the proposed solution the service offers.
      
      \paragraph{Project Plan}
      
      * Approximate timetable of the project progress.
      
      \subsubsection{Chapter 2}
      
      \paragraph{Introduction}
      
      * An introduction to the domain of the service.
      
      \paragraph{Background}
      
      *Who is the service is targeting.
      
      \paragraph{Literature Review}
      
      * A literature review describing the features of the system, from multiple sources.
      
      
      \paragraph{Existing Systems}
      
      * Services that share the same domain and their advantages \& disadvantages.
      
      \paragraph{Comparison}
      
      * Comparison between the services at hand \& other services share the same domain.
      ...
      * Conclusion of the report.
      ...
      • A general introduction of the analysis.
      
      • Analysis serves as a fundamental tool for exploring patterns, trends, and relationships.
      
      \paragraph{Requirements Gathering}
      
      • A description of how the requirements have been gathered.
      
      \paragraph{Functional Requirements}
      
      • The Requirements that the system needs to function.
      
      \paragraph{Non-functional Requirements}
      
      • The Requirements that are expected to be in the system.
      
      \paragraph{Use Case Diagram}
      
      • A display of a use case diagram.
      
      \paragraph{Dynamic Diagram}
      
      • A display of a dynamic diagram, in this case an activity diagram.
      ...
      • An introduction to the detailed design chapter
      
      \paragraph{Static Aspect Design}
      
      • A display of a class diagram for designing functional requirements and reflecting non-functional requirements.
      
      \paragraph{Architectural Aspect Design}
      
      • A presentation of the different hardware components of the proposed solution.
      
      \paragraph{Dynamic Aspect Design}
      
      • A detailed diagram to reflect the internal dynamic of the proposed functional requirements.
      
      \paragraph{User Interface Design}
      
      • A display of the user interface design and screens.
      ...
      · Minimizing the customers' dissatisfaction.
      
      · Improving the barber profession by taking advantage of technology \& ease the process to the customers.
      
      · Giving more chance for barbers to offer their services responding for customers' orders that aren’t necessarily tied to the barbershop place.
      
      · The user can order a barber appointment into his home for people and elders who have movement issues or kids, also people who lack transportation means .
      
      · Improving the profession by minimizing the following
      
      o health risks for both customers and barbers.
      
      *Barbers: 
      
      · avoiding long stands by setting a timer for each session.
      
      * Customers: 
      
      · The customer guarantees the cleanliness of tools in each session.
      
      o Waiting Time
      
      * Customer can check the occupancy level of a barbershop.
      
                
      
      \section{Objectives:}
      
      · A variety of services options offered to customers from the barbershop.
      
      · Ability for customer the price for services.
      
      · Ability for Barbers to rate customers.
      
      · Statistics of time spent daily \& number of customers served.
      
      · Providing the ability of reserving an appointment in a barbershop instead of manually waiting in line.
      
      · A professional certificate for a barber.
      
      · Signing an agreement to comply with the profession's regulations.
      
      · User agreement of sharing data such as phone number and email address as an opportunity to enhance the service for a better experience.
      
      · Shaving tools sold from suppliers to serve both customers and barbers.
      
      ·  Recommendations for customers to enhance their experience.
      ...
      For Customers: The app helps the customers by providing options for both indoor and outdoor barber services and making appointments for the respective services.
      
      For Barbers: The app helps the barbers ensure that they can find multiple opportunities to make their services available, both inside and outside the barber shop.
      
      For Barber shops: The app helps the barber shop increase their customer count, less waiting time for customers, more revenue for the barber shop, and finally overall customer satisfaction.
      
      For suppliers: The app helps the suppliers advertise their products for both customers and barbers, to achieve the desired profit/revenue from selling their products. 
      ...
      \begin{figure}
          \centering
          \includegraphics[width=0.5\linewidth]{Images/Project_plan.png}
      ...
      Acuity Scheduling is a powerful online appointment scheduling tool designed to streamline and simplify the booking process for businesses and service providers. With the following features:
      
      Appointment Scheduling:
      
      · \textbf{Client-Friendly}: Acuity makes it easy for clients to book appointments. Once the client set up his/her account, clients can schedule appointments seamlessly.
      
      · \textbf{Customizable Appointment Types}: the client can create different appointment types (e.g., initial consult, follow-up) with various settings:
      
      o Name the appointment.
      ...
      o Organize appointment types into categories.
      
      o Upload a photo.
      
      o Add intake forms for clients.
      
      o Availability Control: Customize when clients can book by setting limits:
      
      o Choose specific days and times.
      
      o Set advance booking requirements.
      
      o Prevent last-minute cancellations or rescheduling.
      
      o Limit daily or weekly appointments.
      
      o Block off vacation days or personal time.
      
      o Automatic Time Zone Conversion: Acuity detects and converts time zones, eliminating confusion when scheduling across different regions.
      ...
      DaySmart Salon is a robust software solution designed to enhance the management and efficiency of salons, spas, barbershops, nail salons, and other industry-related businesses. The app features are:
       ...
       o Appointment Scheduling and Business Management:
      
      o Versatile Booking App: Formerly known as Salon Iris, DaySmart Salon offers powerful scheduling and business management capabilities.
      
      o For Various Business Sizes: Whether the client run a small hair salon or a large spa, this app suit the client’s needs.
      
      o ­­­Mobile Access: the client can manage his/her salon on-the-go using your iPad, iPhone, Android, or web browser.
      
      o 24/7 Appointment Management: View, add, or edit appointments from anywhere, anytime.
      
      o Remote Business Control: Access over 25 essential features, including business reports, appointment books, payroll totals, marketing, and text messaging.
      
      Key Features:
      
      Efficient Day Management: Free up time by streamlining daily processes.
      
      Client-Centric Approach: Keep clients top-of-mind while handling administrative tasks.
      
      Cloud-Based Solution: Access everything from the front desk or your mobile device.
      
      Designed for Salons and Spas: DaySmart Salon caters exclusively to the salon and spa industry.
      
      Benefits:
      
      Time Savings: Automate communication, appointment scheduling, and reporting.
      
      Engage Staff: Modern technology keeps your team connected.
      
      Business Growth: Efficient management allows you to focus on expanding your business.
      
      Try It Out:
      
      14-Day Free Trial: Experience the power of DaySmart Salon without needing a credit card.
      
      No Commitment: Explore how it simplifies your salon operations.
      
      In summary, DaySmart Salon empowers salon owners and staff to manage their businesses effectively, whether they’re at the front desk or on the move. It’s a comprehensive solution that combines convenience, flexibility, and client satisfaction!
      ...
      The Mindbody app is a free mobile app available for both iOS and Android devices.
      
      Its primary purpose is to help users find and explore various wellness services, including fitness classes, beauty treatments, and integrative health practices.
      ...
      Reference: \href{https://www.wellnessliving.com/}{https://www.wellnessliving.com/}
      ...
      Reference: \href{https://www.zenoti.com/}{https://www.zenoti.com/}
      
      \subsubsection{TheCut App}
      
      TheCut is a powerful barber booking app that simplifies the process of finding talented barbers and scheduling haircuts. Whether you’re a client looking for a fresh trim or a barber managing appointments, here’s an in-depth look at what TheCut offers:
      ...
      Online Booking: Clients can seamlessly book appointments through the Schedulicity app.
      ...
      Digital Calendar: Never miss an appointment with a fully synced calendar.
      ...
      Convenient Transactions: Built-in payment processing for seamless transactions.
      ...
      Beauty Salons: Where magic happens with hair care.
      
      Pricing:
      
      Free Plan: Includes unlimited staff accounts, custom booking website, integrated payments, and automated reminders.
      ...
      \subsection{Comparison}
         ...
         \href{https://www.overleaf.com/Downloads/Comparison_Table.pdf}{..\textbackslash{}..\textbackslash{}..\textbackslash{}Downloads\textbackslash{}Comparison\_Table.pdf}
      ...
      2- Scope Definition: Requirement gathering helps define the scope of the project by identifying the features.
      
      3- Minimizing Errors: By gathering comprehensive requirements upfront.
      
      4- Prioritization: It helps prioritize features and functionalities based on their importance and impact on the user experience.
      
         
      \begin{figure}
          \centering
          \includegraphics[width=0.5\linewidth]{Images/gform1.png}
          \caption{Q1\&2}
          \label{fig:enter-label}Misplaced alignment tab character \&.
      \end{figure}
      
      \begin{figure}
          \centering
          \includegraphics[width=0.5\linewidth]{Images/gform2.png}
          \caption{Q3-Q8}
          \label{fig:enter-label}
      \end{figure}
      \begin{figure}
          \centering
          \includegraphics[width=0.5\linewidth]{Images/gform3.png}
          \caption{Q9\&10}
          \label{fig:enter-label}
      \end{figure}
       \textbf{First form:}
      
      \textbf{Customers can customise their experience by saving preferences, viewing, we found that most replies strongly agree on this feature.}
      
       \textbf{Second form:}
      
      \textbf{Customers can ensure that their contact details and address are correct and up to date, we found that most replies strongly agree on this feature.}
      
       \textbf{Third form:}
      
      \textbf{Customers can learn about the qualifications, experience, and specialties of individual barbers. We found that most replies strongly agree on this feature.}
      
      \textbf{Fourth form:}
      
      \textbf{Customers can communicate their preferences, expectations, and any specific requirements directly to the barber. We found that most replies strongly agree on this feature.}
      
       \textbf{Fifth form: }
      
      \textbf{A platform for rating and reviewing barbers creates a sense of community among customers. We found that most replies strongly agree on this feature.}
      
       \textbf{Sixth form: }
      
      \textbf{Admins can monitor user activity and intervene if necessary to maintain a positive environment within the platform. We found that there were mixed replies, where the majority strongly agrees on this feature, while the minority disagrees on his feature.}
      
       \textbf{Seventh form: }
      
      \textbf{Barbers can showcase their skills, experience, and specialties through their profiles, attracting potential customers and expanding their client base. We found that most replies strongly agree on this feature.}
      
       \textbf{Eighth form: }
      
      \textbf{Chatting with customers allows barbers to clarify any questions, discuss haircut preferences, and provide personalized recommendations. We found that most replies strongly agree on this feature.}
      
        \textbf{Ninth form:}
      
      \textbf{A user-friendly interface ensures that individuals of all abilities can navigate and interact with the system easily, promoting inclusivity and equal access to services. We found that most replies strongly agree on this feature.}
      
       \textbf{Tenth form:}
      
      \textbf{When users feel confident that their privacy is respected and their identity remains anonymous, they are more likely to trust the platform with their personal information and engage more freely. We found that most replies strongly agree on this feature.}
      ...
      • The customer shall be able to create an account in the system.
      
      • The customer shall be able to log into the system.
      
      • The customer shall be able to renew the forgotten password.
      
      • The customer shall be able to update profile information.
      
      • The customer shall be able to View Barber Profiles. 
      
      • The customer shall be able to send orders of appointments to the barber. 
      
      • The customer shall be able to chat with the barber. 
      
      • The customer shall be able to rate and review the barber.
      
      • The customer shall be able to make payments to the barber.
      
      • The customer shall be able to log out of the system.
      
       As for the \textbf{Barber} functionality we have the following requirements:
      
      • The barber shall be able to create an account in the system.
      
      • The barber shall be able to log in to the system. 
      
      • The barber shall be able to reset the password.
      
      • The barber shall be able to update profile information.
      
      • The barber shall be able to receive orders of appointments from customers. 
      
      • The barber shall be able to accept or reject the orders.
      
      • The barber shall be able to chat with the customer. 
      
      • The barber shall be able to view ratings and reviews from customers and rate the customers.
      
      • The barber shall be able to log out of the system.
      
       And finally, for the \textbf{admin} functionality we have the following requirements:
      
      • The admin shall be able to log in to the system.
      
      • The admin shall be able to reset forgotten password. 
      
      • The admin shall be able to view, block, and unblock customers.
      
      • The admin shall be able to view, block, and unblock barbers. 
      
      • The admin shall be able to view and delete reviews and ratings. 
      
      • The admin shall log out from the system.
      ...
      • User friendly: The system will be giving a very user-friendly approach for all users.
      
      • Flexible: Can change the setting - Availability: 24 hours available.
      
      • Accessibility: The phone is accessible to almost everyone and access to the app is also easy. 
      
      • Performance: Response times, processing times, query, and reporting times.
      
      • Easy maintenance: The app is designed easily, so maintenance is also easy.
      
      • Security: The application protects sensitive user information (such as a password).
      
      • Privacy: The user does not want to show his identity.
      ...
      \section{Use Case Diagram}
       ...
       In this section, we are going to display the use case diagram that reflects the functional requirements of the system, starting with the customer functionality, barber functionality and finally the admin functionality.
            ...
            \begin{figure}
                \centering
                \includegraphics[width=1\linewidth]{Images/use case diagram.png}
                \caption{Enter Caption}
                \label{fig:enter-label}
            \end{figure}
      
      \section{Dynamic Diagram}
      ...
      \begin{figure}
          \centering
          \includegraphics[width=0.75\linewidth]{Images/dynamic diagram.png}
          \caption{Enter Caption}
          \label{fig:enter-label}
      \end{figure}
      ...
      \section{Static Aspect Design}
      
      Class Diagram
      \begin{figure}
          \centering
          \includegraphics[width=0.75\linewidth]{Images/Class diagram.png}
          \caption{Enter Caption}
          \label{fig:enter-label}
      \end{figure}
             
      
      \section{Architectural Aspect Design}
      ...
      \section{Dynamic Aspect Design}
      
      Sequence Diagram: sign up and login:
      \begin{figure}
          \centering
          \includegraphics[width=0.75\linewidth]{Images/sequence diagram p1.png}
          \caption{Enter Caption}
          \label{fig:enter-label}
      \end{figure}
      
               Customer service and payment sequence:
               \begin{figure}
                   \centering
                   \includegraphics[width=1\linewidth]{Images/seq p2.png}
                   \caption{Enter Caption}
                   \label{fig:enter-label}
               \end{figure}
      
                  Edit profile, sign out, show barber profile, chat with barber and rate barber sequence:
                  \begin{figure}
                      \centering
                      \includegraphics[width=1\linewidth]{Images/seq p3.png}
                      \caption{Enter Caption}
                      \label{fig:enter-label}
                  \end{figure}
      ...
      \end{figure}
              ...
              \begin{figure}
                  \centering
                  \includegraphics[width=0.75\linewidth]{Images/ui4.png}
                  \caption{Enter Caption}
                  \label{fig:enter-label}
              \end{figure}
                     ...
                     \begin{figure}
                         \centering
                         \includegraphics[width=0.75\linewidth]{Images/ui5.png}
                         \caption{Enter Caption}
                         \label{fig:enter-label}
                     \end{figure}
                 ...
                 \begin{figure}
                     \centering
                     \includegraphics[width=0.75\linewidth]{Images/ui6.png}
                     \caption{Enter Caption}
                     \label{fig:enter-label}
                 \end{figure}
      ...
      \end{figure}
                ...
                \begin{figure}
                    \centering
                    \includegraphics[width=0.75\linewidth]{Images/ui12.png}
                    \caption{Enter Caption}
                    \label{fig:enter-label}
                \end{figure}
      ...
      In conclusion, we have discussed in this chapter the detailed design of the application, starting with the static aspect design using a class diagram to display the functional and non-functional requirements, the architectural aspect design, the dynamic aspect design, and finally the user interface design, this concludes our final chapter.
      ...
      Acuity Scheduling: \href{https://acuityscheduling.com/\#gref}{https://acuityscheduling.com/\#gref}
      
      DaySmart Salon: \href{https://www.daysmart.com/salon/}{https://www.daysmart.com/salon/}
      \textbf{Reference}:  \href{ https://www.mindbodyonline.com/en-gb/business/lp/mindbody?landing=y&utm_source=google&utm_medium=ppc&utm_campaign=20430748488&ad_group=160722387588&utm_term=kwd-329860702&utm_device=c&referralSource=paid+search&matchtype=e&cid=685008699808&networkType=search&adgroupid=160722387588&creative=685008699808&network=g&adGroup=160722387588&_bk=mindbody&_bm=e&gad_source=1&gclid=Cj0KCQiArrCvBhCNARIsAOkAGcXkhoxZN2kd43kY-JN37kZmb38xqd5jLQhS4T8uUtLw5eR_OVGaqy4aAlL3EALw_wcB}{MindBodyOnline}
      
      Vagaro: \href{https://www.vagaro.com/pro/about-us}{https://www.vagaro.com/pro/about-us}
      
      WellnessLiving: \href{https://www.wellnessliving.com/}{https://www.wellnessliving.com/}
      
      Zenoti: \href{https://www.zenoti.com/}{https://www.zenoti.com/}
      
      TheCut App: \href{https://www.thecut.co/}{https://www.thecut.co/}
      
      Setmore: \href{https://www.setmore.com/}{https://www.setmore.com/}
      
      StyleSeat: \href{https://www.styleseat.com/m/}{https://www.styleseat.com/m/}
      
      Square Appointments: \href{https://squareup.com/us/en/appointments}{https://squareup.com/us/en/appointments}
      
      Schedulicity: \href{https://www.schedulicity.com/}{https://www.schedulicity.com/}
      
         Literature review:
      
      Home service: \href{https://www.researchgate.net/publication/358571278_In-Home_Service_Consumption_A_Systematic_Review_Integrative_Framework_and_Future_Research_Agenda}{https://www.researchgate.net/publication/358571278\_In-Home\_Service\_Consumption\_A\_Systematic\_Review\_Integrative\_Framework\_and\_Future\_Research\_Agenda}
      
      User-Friendly interface: \href{https://doi.org/10.1155/2017/6787504}{https://doi.org/10.1155/2017/6787504}
      
      Convenient appointment booking: \href{https://www.primescholars.com/articles/literature-review-on-appointment-scheduling-in-hospitals-management.pdf}{https://www.primescholars.com/articles/literature-review-on-appointment-scheduling-in-hospitals-management.pdf}
      
      Automated Reminders/alerts: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4912908/}{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4912908/}
      
      Payment system: \href{https://www.researchgate.net/publication/329838236_A_Review_of_E-Payment_System_in_E-Commerce}{https://www.researchgate.net/publication/329838236\_A\_Review\_of\_E-Payment\_System\_in\_E-Commerce}
      
      Rating/Review System: \href{https://www.researchgate.net/publication/317631936_An_Examination_of_the_Current_Rating_System_used_in_Mobile_App_Stores}{https://www.researchgate.net/publication/317631936\_An\_Examination\_of\_the\_Current\_Rating\_System\_used\_in\_Mobile\_App\_Stores}
      
       \textbf{Chapter 3:}
      
      Requirements Gathering google form:
      
      \href{https://docs.google.com/forms/d/e/1FAIpQLSes28stJGbO_i-1EmL-VT60-TKeAUTfT0DXHwRMSb1ncaQepA/viewform?usp=sf_link}{https://docs.google.com/forms/d/e/1FAIpQLSes28stJGbO\_i-1EmL-VT60-TKeAUTfT0DXHwRMSb1ncaQepA/viewform?usp=sf\_link}
      
      Use case diagram:
      
      \href{https://lucid.app/lucidchart/invitations/accept/inv_47530d0c-9e96-43cc-8c8e-ea354d96ebdf}{https://lucid.app/lucidchart/invitations/accept/inv\_47530d0c-9e96-43cc-8c8e-ea354d96ebdf}
      
      Dynamic Diagram (Activity Diagram)
      
      \href{https://lucid.app/lucidchart/invitations/accept/inv_e6a319dc-4328-489a-9ac8-e24d1eb38706}{https://lucid.app/lucidchart/invitations/accept/inv\_e6a319dc-4328-489a-9ac8-e24d1eb38706}
      
       \textbf{Chapter 4:}
       User interface design:
       \textbf{Reference}: \href{https://www.figma.com/proto/vcdFPDnXduhTrPKnwB27uj/Haircut?node-id=2-11&t=U3ZWMewK0ODQ4fIH-1&scaling=scale-down&page-id=0%3A1&starting-point-node-id=2%3A11&show-proto-sidebar=1}{User interface design}
\end{itemize}
