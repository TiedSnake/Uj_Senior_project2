...
\end{figure}
    ...
    \begin{tabular}{|c |c|} \hline  % Define the number of columns and their alignment
        \textbf{\fontsize{18}{20}\selectfont Students' Names}& \textbf{\fontsize{18}{20}\selectfont ID(s)}\\ \hline         
...
\\ \hline 
 ...
 Sari Alblwi&2142407\\ \hline
    ...
    \textbf{Supervisor}&Sakher Ghanem\\ \hline
    \end{tabular}
    ...
    \vspace{3em}\begin{tabular}{|c|} \hline
        ...
        Academic Session: Winter 2024 \\ \hline
    \end{tabular}
    \endgroup
\end{table}
\newpage
