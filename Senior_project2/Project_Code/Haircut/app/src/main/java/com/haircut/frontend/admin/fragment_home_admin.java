...
public class fragment_home_admin extends Fragment {
    ...
    private void initializeUserLists() {
        ...
        barbersList.add(new UserDataModel2("90 seconds Salon", "View", "Block", "Delete"));
        barbersList.add(new UserDataModel2("Maria Salon", "View", "Block", "Delete"));
        clientsList = new ArrayList<>();
        clientsList.add(new UserDataModel2("Ahmad Khalid", "View", "Block", "Delete"));
        clientsList.add(new UserDataModel2("Osama Nasser", "View", "Block", "Delete"));
        clientsList.add(new UserDataModel2("Yasser Faris", "View", "Block", "Delete"));
    }
